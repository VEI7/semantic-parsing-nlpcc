...
class SummarizationModel(object):
  ...
  def _add_seq2seq(self):
    ...
    word_embedding_init = pickle.load(open(hps.embedding_path, 'rb'))
    word_embedding_initializer = tf.constant_initializer(word_embedding_init)
    with tf.variable_scope('seq2seq'):
      ...
      with tf.variable_scope('embedding'):
        ...
        embedding = tf.get_variable('embedding', [vsize, hps.emb_dim], dtype=tf.float32, initializer=word_embedding_initializer)
