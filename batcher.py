...
class Batcher(object):
  ...
  def fill_example_queue(self):
    ...
    input_gen = self.text_generator(data.example_generator(self._data_path, self._single_pass, self._hps.entity_replace))
  ...
  def text_generator(self, example_generator):
    ...
    while True:
      (article_text, abstract_text) = next(example_generator) # e is a tf.Example
